...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity webSecurity) throws Exception {
		webSecurity.ignoring().antMatchers(HttpMethod.POST, authenticationPath).antMatchers(HttpMethod.OPTIONS, "/**")
				.and().ignoring().antMatchers(HttpMethod.GET, "/", "/api/account/checkAccount/**", "/api/criteria")
				.antMatchers(HttpMethod.POST, "/api/account", "/api/search", "/api/search/image")
				.antMatchers(HttpMethod.GET, "/", "/api/province", "/api/province/*", "/api/province/pagination/*")
				.antMatchers(HttpMethod.GET, "/api/district", "/api/district/*", "/api/district/provinceId/*")
				.antMatchers(HttpMethod.GET, "/api/ward", "/api/ward/*")
				.antMatchers(HttpMethod.POST, "/api/upload", "/api/multi-upload")
